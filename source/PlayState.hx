...
class PlayState extends MusicBeatState
{
	...
	var judgementCounter:FlxText; // send a screenshot on discord what it look like
	var timeTxt:FlxText;
	...
	override public function create()
	{
		...
		scoreTxt.visible = !ClientPrefs.hideHud; // i also did the clientprefs shit and the add score text but it didnt work
		add(scoreTxt);
		...
		judgementCounter.cameras = [camHUD]; // um hold on
