...
class StrumNote extends FlxSprite
{
	...
	public function new(x:Float, y:Float, leData:Int, player:Int) {
		...
		if(ClientPrefs.daNoteType == 'Normal') {
			skin = 'NOTE_assets';
		} else if(ClientPrefs.daNoteType == 'Circle') {
...
class StrumNote extends FlxSprite
{
	...
	public function new(x:Float, y:Float, leData:Int, player:Int) {
		...
		if(strumOffsets.exists(ClientPrefs.daNoteType))
		{
			var addOffset:Array<Dynamic> = strumOffsets.get(ClientPrefs.daNoteType);
	...
	public function reloadNote()
	{
		...
		var coolswag:String = '';
		if(ClientPrefs.daNoteType != 'Default')
		{
			coolswag = '-' + ClientPrefs.daNoteType.toLowerCase().replace(' ', '-');
		}
