...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			[''],
			['Contributors'],
			['Chillyhzcar', 'chillyhczar', 'Remastered Some Icons', 'https://gamebanana.com/members/2009822', '89cff0'],
            [''],
			['Special Thanks'],
            ['Leather128',		'leather engine guy',		'Made Winning Icons Used And also did the healthicon.hx code.',						'https://gamebanana.com/members/1799813',	'00FFFF'],
